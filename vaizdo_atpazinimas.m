...
T = [eye(13), eye(13), eye(13), eye(13), eye(13), eye(13), eye(13), eye(13)];
...
for k = 1:raidziu_sk
    switch b2(k)
        ...
        case 4
            atsakymas = [atsakymas, 'Ə'];
        case 5
            atsakymas = [atsakymas, 'N'];
        case 6
            atsakymas = [atsakymas, 'Ö'];
        case 7
...
pavadinimas = 'test_Azerbaycan.png';
pozymiai_patikrai = pozymiai_raidems_atpazinti(pavadinimas, 1);
